...
class wp_braintree {
    ...
    public function wp_braintree_admin_styles() {
        ...
        ?><link rel="stylesheet" href="http://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css"><?php
...
// End public function
    ...
    public function wp_braintree_button_shortcode($atts) {
        ...
        $button_form .= '<input type="button" value="' . $button_text. '" name="submit_button_form" class="submit_buy_now" />';
        $button_form .= '</form>';
        $button_form .= '</div>';
